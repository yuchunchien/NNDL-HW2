...
def test_mlp_dropout(learning_rate=0.01, L1_reg=0.0, L2_reg=0.0001, n_epochs=500,
    ...
    hiddenlayer_one = DropoutHiddenLayer(rng=rng, 
    ...
    logRegressionLayer = LogisticRegression(input=hiddenlayer_two.output,
                                            n_in=n_hidden,
                                            n_out=10)
    ...
    L1 = abs(logRegressionLayer.W).sum() + abs(hiddenlayer_one.W).sum() + abs(hiddenlayer_two.W).sum()
    
    # square of L2 norm ; one regularization option is to enforce
    # square of L2 norm to be small
    #TODO: Define the expression for L2_sqr
    L2_sqr = (logRegressionLayer.W ** 2).sum() + (hiddenlayer_one.W ** 2).sum() + (hiddenlayer_two.W ** 2).sum()
    ...
    params = logRegressionLayer.params + hiddenlayer_one.params + hiddenlayer_two.params
